...
(function() {
	...
	/** ********************************************************************************************* */
	// 注意此处为开发者潘海南添加
	var imageUploadURL = "/dreamstation/";
	/** ********************************************************************************************* */
	/**
	...
	window.UMEDITOR_CONFIG = {
		...
		// 图片上传配置区
		,
		imageUrl : imageUploadURL + "imageUp.jsp" // 图片上传提交地址
		,
		imagePath : imageUploadURL // 图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
		,
		...
		toolbar : [
				...
				'link unlink | image ', '| horizontal  preview fullscreen' ]
