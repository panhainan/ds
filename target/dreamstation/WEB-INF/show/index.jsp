				...
				<div id="carousel-generic" class="carousel slide"
						...
						<c:choose>
							<c:when test="${fn:length(listIndexInfo)>0}">
								<c:forEach var="num" step="1" begin="0"
									end="${fn:length(listIndexInfo)<2?fn:length(listIndexInfo)-1:fn:length(listIndexInfo)-2}" varStatus="status">
					...
					<div class="carousel-inner" role="listbox">
						<c:choose>
							...
							<%-- <c:otherwise>
								<div class="item active">
									<img src="<%=basePath%>img/index/chuancheng.jpg"
										class="img-responsive" alt="传承">
									<div class="carousel-caption">
										<h3>传承</h3>
										<p>传文化，承精神；传经典，承创新</p>
									</div>
								...
								<div class="item">
									<img src="<%=basePath%>img/index/chuangxin.jpg"
										class="img-responsive" alt="创新">
									<div class="carousel-caption">
										<h3>创新</h3>
										<p>开创人生，拓新未来</p>
									</div>
								...
								<div class="item">
									<img src="<%=basePath%>img/index/hezuo.jpg"
										class="img-responsive" alt="合作">
									<div class="carousel-caption">
										<h3>合作</h3>
										<p>合作成就效益，合作体验温度，合作决定未来</p>
									</div>
								</div>
								<div class="item">
									<img src="<%=basePath%>img/index/fengxian.jpg"
										class="img-responsive" alt="奉献">
									<div class="carousel-caption">
										<h3>奉献</h3>
										<p>给予也是一种快乐</p>
									</div>
								...
								<div class="item">
									<img src="<%=basePath%>img/index/pinbo.jpg"
										class="img-responsive" alt="拼搏">
									<div class="carousel-caption">
										<h3>拼搏</h3>
										<p>拼人生，搏未来</p>
									</div>
