	...
	<div class="container"
		...
		<div class="row">
			<ol class="breadcrumb container">
				...
				<li class="last"><a href="<%=basePath%>member/go-register"
					class="active">注册</a></li>
			</ol>
			<p style="margin: 20px;color: red">&emsp;&emsp;抱歉，注册失败!</p>
			...
			<div style="margin: 20px;">
				<form class="form-horizontal" action="<%=basePath%>member/register"
					...
					<div class="form-group">
						<label for="grade" class="col-sm-4 control-label">目前情况</label> <select
							name="gradeNumber" class="col-sm-3  input-sm" id="grade"
					...
					<div class="form-group">
						...
						<select class="col-sm-3  input-sm" id="category"
							name="categoryNumber" style="margin-left: 15px;">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="email" name="loginEmail" class="form-control"
								id="email" placeholder="请输入常用邮箱，用来进行登录和其他操作">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="password" class="form-control" name="loginPass"
								id="loginpass" placeholder="请输入登录密码">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" name="qq" id="qq"
								placeholder="请输入Q Q 号码">
						</div>
					</div>
					<div class="form-group">
						<label for="introduction" class="col-sm-4 control-label">个人简介</label>
						<div class="col-sm-6">
							<textarea style="resize:none" name="introduction"
								class="form-control" id="qq" placeholder="请输入150字以内的个人介绍"></textarea>
						</div>
					</div>
