...
<title>梦之站 | 科研成果 | ${projectInfo.name}</title>
...
.project-content img,.project-content object {
	max-width: 100%;
	height: auto;
}
</style>
	...
	<div class="container"
		...
		<div class="row">
			<ol class="breadcrumb container">
				...
				<li><a href="<%=basePath%>project/list">科研项目</a>
				</li>
				<li class="last"><a
					href="<%=basePath%>project/look?id=${projectInfo.id}"
					class="active">${projectInfo.name}</a>
				</li>
			</ol>
			<div id="content" style="margin: 40px;">
				<h1 style="text-align: center;">${projectInfo.name}</h1>
				<p>
					<span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;<b>${projectInfo.author}</b>
					${projectInfo.groupMember}&nbsp;&nbsp; <span
						class="glyphicon glyphicon-time" aria-hidden="true"></span>&nbsp;${projectInfo.publishTime}&nbsp;&nbsp;项目访问地址：<a href="${projectInfo.website}" target="_blank" >${projectInfo.website}</a> 
				</p>
				<br>
				<div class="project-content">${projectInfo.details}</div>
			</div>
		</div>
	</div>
	<!-- 底部版权声明 -->
