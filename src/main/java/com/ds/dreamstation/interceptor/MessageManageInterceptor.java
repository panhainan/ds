 ...
 * @TODO 
 */
public class MessageManageInterceptor extends HandlerInterceptorAdapter {
	
	@Override
	public boolean preHandle(HttpServletRequest request,
			HttpServletResponse response, Object handler) throws Exception {
		System.out.println("MessageManageInterceptor:perHandle");
		HttpSession session = request.getSession();
		MemberSession memberSession  = (MemberSession)session.getAttribute("memberSession");
		if(memberSession.isManageMessage())
		{
			return true;
		}
	...
	public void postHandle(HttpServletRequest request,
		...
		System.out.println("MessageManageInterceptor:postHandle");
