 ...
 * @TODO 
 */
public class NewsPublishInterceptor extends HandlerInterceptorAdapter {
	
	@Override
	public boolean preHandle(HttpServletRequest request,
			HttpServletResponse response, Object handler) throws Exception {
		System.out.println("NewsPublishInterceptor:perHandle");
		HttpSession session = request.getSession();
		MemberSession memberSession  = (MemberSession)session.getAttribute("memberSession");
		if(memberSession.isPublishNews())
		{
			return true;
		}
	...
	public void postHandle(HttpServletRequest request,
		...
		System.out.println("NewsPublishInterceptor:postHandle");
