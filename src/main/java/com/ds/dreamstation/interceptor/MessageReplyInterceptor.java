 ...
 * @TODO
 */
public class MessageReplyInterceptor extends HandlerInterceptorAdapter {

	@Override
	public boolean preHandle(HttpServletRequest request,
			HttpServletResponse response, Object handler) throws Exception {
		System.out.println("MessageReplyInterceptor:perHandle");
		HttpSession session = request.getSession();
		MemberSession memberSession = (MemberSession) session
				.getAttribute("memberSession");
		if (memberSession.isReplyMessage()) {
			return true;
		}
	...
	public void postHandle(HttpServletRequest request,
		...
		System.out.println("MessageReplyInterceptor:postHandle");
