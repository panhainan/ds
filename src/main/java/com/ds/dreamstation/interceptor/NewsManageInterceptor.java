 ...
 * @TODO
 */
public class NewsManageInterceptor extends HandlerInterceptorAdapter {

	@Override
	public boolean preHandle(HttpServletRequest request,
			HttpServletResponse response, Object handler) throws Exception {
		System.out.println("NewsManageInterceptor:perHandle");
		HttpSession session = request.getSession();
		MemberSession memberSession = (MemberSession) session
				.getAttribute("memberSession");
		if (memberSession.isManageNews()) {
			return true;
		}
	...
	public void postHandle(HttpServletRequest request,
		...
		System.out.println("NewsManageInterceptor:postHandle");
