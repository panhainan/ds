	...
	<div class="container"
		...
		<div class="row">
			<ol class="breadcrumb container">
				...
				<li class="last"><a href="<%=basePath%>member/programmer/list"
					class="active">程序组</a>
				</li>
			</ol>
			...
			<div id="content" class="col-md-12">
				<div class="row" >
					<c:forEach items="${listProgrammerInfo}" var="programmerInfo">
						<div class="col-md-3 item" style="height: 500px;">
							<div class="thumbnail">
								<a href="<%=basePath%>member/look?id=${programmerInfo.id}"><img  onerror="this.src='<%=basePath%>img/default.png'" 
									src="<%=basePath%>${programmerInfo.picture}" alt="${programmerInfo.name}"
									style="max-height:260px;"
									data-original-title="${programmerInfo.name}"
									class="img-responsive imgpop"> </a>
								<div class="caption">
									<h4>
										<a href="<%=basePath%>member/look?id=${programmerInfo.id}">${programmerInfo.name}</a>
									</h4>
									<p style="font-size: 12px;" >&emsp;&emsp;${programmerInfo.introduction}</p>
									<p>
										<a href="<%=basePath%>member/look?id=${programmerInfo.id}"
						...
						<c:choose>
							...
							<c:otherwise>
								<li class="next last"><a
									href="<%=basePath%>member/programmer/list?current=${pageBean.currentPage-1}"
									title="去上一个页面" class="active">‹ 上一页 </a>
								</li>
							</c:otherwise>
						</c:choose>
						<li class="next last"><a
							href="<%=basePath%>member/programmer/list?current=1" title="去首页"
							class="active first">首页</a>
						</li>
						<li class="active first"><a
							href="<%=basePath%>member/programmer/list?current=${pageBean.currentPage}">${pageBean.currentPage}</a>
						</li>
						<li class="next last"><a
							href="<%=basePath%>member/programmer/list?current=${pageBean.totalPages}"
