	...
	<div
		...
		<div style="width: 100%">
			<div style="width: 50%;float: left;">
				...
				邮箱：${memberInfo.loginEmail}<br /> <br />
			</div>
			<div style="width: 50%;float: left;">
				<img width="60%" alt="" src="<%=basePath%>${memberInfo.picture}">
			</div>
		</div>
		<div style="width: 100%;float: left;">
			简介：${memberInfo.introduction}<br /> <br /> 详细介绍：
			${memberInfo.details}<br /> <br />
		</div>
	</div>
	<div style="margin:30px 0 0 0;font-size: 16px;width: 40%;float: left;">
		...
		<div align="center" style="width: 100%">
			<input type="button"
				...
				class="btn"
				onclick="window.location.href='<%=basePath%>member/manage/list'"
				value="返回列表">
			<c:if test="${memberSession.manageMember==true}">
				&emsp;&emsp; <input type="button" class="btn" style="width: 60px"
					onclick="window.location.href='<%=basePath%>member/manage/remove?id=${memberInfo.id}'"
					value="删除">
			</c:if>
		</div>
	</div>
