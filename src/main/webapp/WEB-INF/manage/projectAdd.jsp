...
<body>
	...
	<div class="place">
		<span>位置：</span>
		<ul class="placeul">
			<li><a href="<%=basePath%>project/manage/list">项目管理</a></li>
			<li><a href="<%=basePath%>project/manage/go-add">发布项目</a></li>
		</ul>
	</div>
	<div style="margin:30px 0 0 40px;">
		<form action="<%=basePath%>project/manage/add" method="post" enctype="multipart/form-data">
			项&nbsp;&nbsp;目&nbsp;&nbsp;名&nbsp;&nbsp;称：<input name="name" type="text" class="dfinput"
				style="width:800px;" /><br /> <br /> 
			项&nbsp;&nbsp;目&nbsp;负责人：<input name="author" type="text" class="dfinput"
				style="width:800px;" /><br /> <br /> 
			项&nbsp;&nbsp;目&nbsp;&nbsp;组&nbsp;&nbsp;员：<input name="groupMember" type="text" class="dfinput"
				style="width:800px;" /><br /> <br /> 
			项目展示图片：<input type="text" class="dfinput" style="width: 600px;"
			...
			项目访问地址：<input name="website" type="text" class="dfinput"
				style="width:800px;" /><br /> <br /> 
			项目简介：<br /> <br /> <textarea style="width:1000px;height: 80px;resize:none;line-height: 26px;" class="dfinput" name="summary"></textarea> <br /> <br />
			项目详细内容：<br /> <br />
			<!-- 加载编辑器的容器 -->
